...
setup(
    name="fdadb",
    version=version,
    url="https://github.com/HealthByRo/fdadb",
    license="MIT",
    description="FDA Drug Database",
    long_description=read_file("README.rst"),
    author="Michal Proszek",
    author_email="michal.proszek@gmail.com",
    packages=get_packages("fdadb"),
    package_data=get_package_data("fdadb"),
    zip_safe=False,
